// firmware/preview/glcdfont.h
//
// Host-only copy of Adafruit_GFX_Library's glcdfont.c (the "classic" 5x7
// bitmap font Adafruit_GFX falls back to when no GFXfont is set via
// setFont()). Byte-for-byte identical to the vendored font; only the AVR/
// PROGMEM header guards are dropped since Adafruit_GFX.h in this directory
// already #defines PROGMEM to nothing for host builds.
#pragma once

static const unsigned char kGlcdFont[] = {
